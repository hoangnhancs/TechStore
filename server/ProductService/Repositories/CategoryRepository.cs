...
namespace ProductService.Repositories
{
    ...
    /// </summary>
    public class CategoryRepository : BaseEFRepository<Category, int, ProductSvcDbContext>, ICategoryRepository
    {
        public CategoryRepository(ProductSvcDbContext context) : base(context)
        {
        }
